...
class Registro(QMainWindow):
    def __init__(self):
        ...
        self.Button_cancelar.clicked.connect(self.cancelar) #cuando oprime el boton de cancelar se cierra la ventana y se abre la de inicio de sesion
        self.Button_registro.clicked.connect(self.Registrar_usuario) #cuando oprime el boton de registrar se registra el usuario
        self.Button_registro.clicked.connect(self.vaciar_textbox) #cuando oprime el boton de registrar se vacian los textbox
